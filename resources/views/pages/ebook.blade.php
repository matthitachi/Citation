    ...
    <nav class="navbar navbar-expand-lg navbar-light  " id="citation_source">
        ...
        <div class="collapse navbar-collapse" id="navbar2">
            <div class="navbar-nav m-auto">
                ...
                <a class="nav-item nav-link pl-4 pr-4 active" href="/{{$style}}/ebook" >E-book</a>
...
@section('content')
    <div class="form-body m-5">
        <form onsubmit="ebook_form(event)">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Author of E-book</label>
                <div class="col-sm-9">
                    <div id="author">
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Title of E-book</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter title of the page">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Publisher</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="publisher"   placeholder="Enter the name of publisher">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Place of Publication</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control"  name="location" placeholder="Enter the location (City, US State or Country">
                </div>
            </div>
