            ...
            <div class="navbar-nav m-auto">
                ...
                <li class="nav-item dropdown pl-4 pr-4">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item ative" href="/{{$style}}/newspaper" >Newspaper</a>
...
@section('content')
    <div class="form-body m-5">
        <form onsubmit="newspaper_form(event)">
            <input type="hidden" name="source" id="citation_type" value="newspaper"/>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter title of the article">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Name of News Source</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control"  name="news_title" placeholder="Enter the name of news source">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <input type="number" class="form-control" required  name="month" placeholder="MM">
                        </div>
                        <div class="col-4">
                            <input type="number" class="form-control" required  name="day" placeholder="DD">
                        </div>
                    </div>
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Page Range</label>
                <div class="col-sm-4">
                    <input type="number" class="form-control"  name="page_start" placeholder="Enter the page start range">
                </div>
                <div class="offset-1 col-sm-4">
                    <input type="number" class="form-control"  name="page_end" placeholder="Enter the page end range">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div>
                        <div class="row">
                            <div class="col-6">
                                <input type="text" class="form-control"  name="editor_firstname" placeholder="First name">
                            </div>
                            <div class="col-6">
                                <input type="text" class="form-control"  name="editor_lastname" placeholder="Last name">
                            </div>
                        </div>
                    </div>
