            ...
            <div class="navbar-nav m-auto">
                ...
                <li class="nav-item dropdown pl-4 pr-4">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="/{{$style}}/dissertation" >Dissertation</a>
...
@section('content')
    ...
    <div class="form-body m-5">
        <form onsubmit="dissertation_form(event)">
            <input type="hidden" name="source" id="citation_type" value="dissertation">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Date of Publication</label>
                <div class="col-sm-9">
