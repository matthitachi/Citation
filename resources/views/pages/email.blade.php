            ...
            <div class="navbar-nav m-auto">
                ...
                <li class="nav-item dropdown pl-4 pr-4">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="/{{$style}}/email" >Email</a>
...
@section('content')
    ...
    <div class="form-body m-5">
        <form onsubmit="email_form(event)">
            <input type="hidden" name="source" id="citation_type" value="email">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Sender</label>
                <div class="col-sm-9">
                    <div id="author">
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="form-group row">
                <label for="pop" class="col-sm-3 col-form-label">Send Date</label>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-4">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Email Subject</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" required   id="title" name="title" placeholder="The subject line of email">
                </div>
            </div>
