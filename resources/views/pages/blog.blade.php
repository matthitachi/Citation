            ...
            <div class="navbar-nav m-auto">
                ...
                <li class="nav-item dropdown pl-4 pr-4">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="/{{$style}}/blog" >Blog</a>
...
@section('content')
    <div class="form-body m-5">
        <form onsubmit="blog_form(event)">
            ...
            <div class="form-group row">
                <label for="pop" class="col-sm-3 col-form-label">Post Date</label>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-4">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Blog Name</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" required  id="title" name="title" placeholder="Enter the title of blog">
                </div>
            </div>
<div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">URL</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" required  name="url" placeholder="Enter blog url">
                </div>
            </div>
