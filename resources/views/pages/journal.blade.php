    ...
    <nav class="navbar navbar-expand-lg navbar-light  " id="citation_source">
        ...
        <div class="collapse navbar-collapse" id="navbar2">
            <div class="navbar-nav m-auto">
                ...
                <a class="nav-item nav-link pl-4 pr-4 active" href="/{{$style}}/journal" >Journal</a>
...
@section('content')
    ...
    <div class="form-body m-5">
        <form onsubmit="journal_form(event)">
            <input type="hidden" name="source" value="journal">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Author of Article</label>
                <div class="col-sm-9">
                    <div id="author">
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Title of Article</label>
                <div class="col-sm-9">
                    <input type="text" required  class="form-control" id="title" name="title" placeholder="Enter title of article">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Name of Journal</label>
                <div class="col-sm-9">
                    <input type="text" required  class="form-control"  name="journal_name" placeholder="Enter name of journal">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Volume number</label>
                <div class="col-sm-9">
                    <input type="number" class="form-control"  name="volume" placeholder="Enter volume number">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Issue  number</label>
                <div class="col-sm-9">
                    <input type="number" class="form-control"  name="issue" placeholder="Enter issue number">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Page</label>
                <div class="col-sm-9">
                    <input type="number" class="form-control"  name="page" placeholder="Enter page/pages number">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-4">
                            <input  required type="number" class="form-control" name="year" placeholder="YYYY">
                        </div>
                        <div class="col-4">
                            <input type="v" class="form-control" name="month" placeholder="MM">
                        </div>
                        <div class="col-4">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Editor</label>
                <div class="col-sm-9">
                    <div id="author">
                        <div class="row">
                            <div class="col-6">
                                <input type="text" required  class="form-control"   required name="editor_firstname" placeholder="First name">
                            </div>
                            <div class="col-6">
                                <input type="text" required  class="form-control"  required  name="editor_lastname" placeholder="Last name">
                            </div>
                        </div>
                    </div>
