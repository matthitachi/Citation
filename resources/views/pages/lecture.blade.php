            ...
            <div class="navbar-nav m-auto">
                ...
                <li class="nav-item dropdown pl-4 pr-4">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="/{{$style}}/lecture" >Presentation or Lecture</a>
...
@section('content')
    <div class="form-body m-5">
        <form onsubmit="website_form(event)">
            <input type="hidden" name="source" id="citation_type" value="website">
            <input type="hidden" name="style" id="citation_style" value="website">
            <div class="form-group row">
                <label for="book" class="col-sm-3 col-form-label">URL (website address)</label>
                <div class="col-sm-9">
                    <input type="text"  class="form-control" required  name="url" value="" placeholder="Enter website page">
                </div>
            </div>
            <div class="form-group row">
                <label for="subject" class="col-sm-3 col-form-label">Subject</label>
                <div class="col-sm-9">
                    <select id="subject" class="form-control" name="Book[subject_id]">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Author of webpage</label>
                <div class="col-sm-9">
                    <div id="author">
                        <div class="row">
                            <div class="col-6">
                    ...
                    <div class="add-author">
                        <a href="" onclick="add()"> <span><i class="fa fa-plus-circle" aria-hidden="true"></i> Add another author</span></a>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Title of webpage</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control "  required  name="title" id="inputPassword" placeholder="Enter title of webpage">
                </div>
            </div>

            <div class="form-group row">
                <label for="pop" class="col-sm-3 col-form-label">Date Published</label>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-4">
                            <input type="number" required  class="form-control" name="year" placeholder="YYYY">
                        </div>
                        <div class="col-4">
                            <input type="number" required  class="form-control" name="month" placeholder="MM">
                        </div>
                        <div class="col-4">
                            <input type="number" required  class="form-control" name="day" placeholder="DD">
                        </div>
                    </div>
            ...
            <div class="form-group row">
                <label for="pop" class="col-sm-3 col-form-label">Date Viewed</label>
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-4">
                            <input type="number" required class="form-control" name="access_year" placeholder="YYYY">
                        </div>
                        <div class="col-4">
                            <input type="number" required  class="form-control" name="access_month" placeholder="MM">
                        </div>
                        <div class="col-4">
                            <input type="number" required class="form-control" name="access_day" placeholder="DD">
                        </div>
                    </div>
