            ...
            <div class="navbar-nav m-auto">
                ...
                <li class="nav-item dropdown pl-4 pr-4">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="/{{$style}}/interview" >Interview</a>
...
@section('content')
    ...
    <div class="form-body m-5">
        <form onsubmit="interview_form(event)">
            <input type="hidden" name="source" id="citation_type" value="interview">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control"  name="title" placeholder="A title or description of interview">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Interviewer full name</label>
                <div class="col-sm-9">
                    <div id="author">
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-3 col-form-label">Format</label>
                <div class="col-sm-9">
                    <select id="interview-format" class="form-control" name="format" aria-invalid="false">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control"  name="location" placeholder="The location the interview was carried out at">
                </div>
            </div>
